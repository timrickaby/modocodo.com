	...
	<div id="work" class="row">
		...
		<div class="project">
			...
			<div class="row">
				...
				<div class="column-1-2">
					<div class="item" data-type="media">
						<img src="http://modocodo.test/work/healey-amplification-cards.jpg" width="100%" />
						<div class="caption">
							<p>Customers were able to produce custom logoforms when testing the amplifier.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="project">
			<div class="item" data-type="copy">
				<h2>Adidas P.O.D System Retail Launch</h2>
				<h3>Retail and point of sale. Concepts, design and production guidelines.</h3>
				<h4>(IMA / Adidas)</h4>
			</div>
		...
		<div class="project">
			...
			<div class="row">
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/haworth-festival-logo-01.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/haworth-festival-logo-02.jpg" width="100%" />
					</div>
				</div>
			</div>
			<div class="item" data-type="image">
			...
			<div class="item" data-type="image">
				<img src="http://modocodo.test/work/haworth-festival-collateral.jpg" width="100%" />
			</div>
		</div>
		...
		<div class="project">
			<div class="item" data-type="copy">
				<h2>Adidas Originals – Nite Jogger VR Experience</h2>
				<h3>Concept and design of worldwide in-store product launch activation.</h3>
				<h4>(IMA)</h4>
			</div>
			<div class="item" data-type="image">
				<img src="http://modocodo.test/work/adidas-nite-jogger-vr-flat-render.jpg" width="100%" />
				<div class="caption">
					<p>Flat visual of the 3D environment.</p>
				</div>
			</div>
			<div class="item" data-type="embed">
				<div class="media-wrapper">
				...
				<div class="caption">
					<p>3D environment produced for Occulus Rift headsets.</p>
				</div>
			</div>
			<?php /*
			<div class="row">
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-nite-jogger-instore-01.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-nite-jogger-instore-02.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-nite-jogger-instore-03.jpg" width="100%" />
					</div>
				</div>
			</div>
			*/ ?>
		...
		<div class="project">
			...
			<div class="row">
				...
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/foot-locker-and-jd-sports-05.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/foot-locker-and-jd-sports-06.jpg" width="100%" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/foot-locker-and-jd-sports-07.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/foot-locker-and-jd-sports-08.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-3">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/foot-locker-and-jd-sports-09.jpg" width="100%" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="project">
			<div class="item" data-type="copy">
				...
				<h3>'Find Focus' product launch campaign involved window and in store execution.</h3>
				<h4>(IMA / Adidas / JD Sports)</h4>
			</div>
			<div class="row">
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-athletics-install-01.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-athletics-install-02.jpg" width="100%" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-athletics-install-03.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/adidas-athletics-install-04.jpg" width="100%" />
					</div>
				</div>
			</div>
			<div class="item" data-type="embed">
				...
				<div class="caption">
					<p>Foot Locker, Harrods and WIT Launch behind the scenes.</p>
				</div>
			</div>
		</div>
		...
		<div class="project">
			...
			<div class="item" data-type="embed">
				...
				<div class="caption">
					<p>Liza & Henry animated music video.</p>
				</div>
			</div>
			<div class="item" data-type="image">
		...
		<div class="project">
			<div class="item" data-type="copy">
				...
				<h4>View Product on Adobe Exchange</h4>
			</div>
			<div class="item" data-type="image">
		...
		*/ ?>
		...
		<div class="project">
			...
			<div class="row">
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/hayim-logo-01.jpg" width="100%" />
					</div>
				</div>
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/hayim-logo-02.jpg" width="100%" />
					</div>
				</div>
			</div>
			<div class="item" data-type="image">
				<img src="http://modocodo.test/work/hayim-tags.jpg" width="100%" />
			</div>
		</div>
		...
		<div class="project">
			...
			<div class="row">
				<div class="column-1-2">
					<div class="item" data-type="image">
						<img src="http://modocodo.test/work/logos-aire-valley-archers.jpg" width="100%" />
						<div class="caption">
							<p>Aire Valley Archers</p>
						</div>
					</div>
				</div>
				<div class="column-1-2">
