...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/header.php'); ?>
	...
	<div id="work" class="row">
		...
		<div class="project">
			...
			<div class="item" data-type="image">
				<img src="http://modocodo.test/work/awesome-exporter-logo-01.jpg" width="100%" />
			</div>
		</div>
		...
		<div class="project">
			...
			<div class="item" data-type="image">
				<img src="http://modocodo.test/work/logos-resqyou.jpg" width="100%" />
				<div class="caption">
					<p>Aire Valley Archers – Archery Club</p>
				</div>
			</div>
		</div>
	</div>
